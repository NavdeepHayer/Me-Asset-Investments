export const siteContent = {
  ...
  projects: {
    ...
    items: [
      // Current Projects
      {
        name: "Premier Inn, Swansea",
        location: "Swansea, Wales",
        type: "132-Bed Hotel",
        status: "Current",
        description: "Full facade remediation including render, aluminium cladding, brick, and insulation. Project value: £5.3m",
        image: "/images/projects/swansea.jpeg",
      },
      {
        name: "Skyline Chambers",
        location: "Manchester",
        type: "Residential Development",
        status: "Current",
        description: "16-month facade remediation project including render, aluminium cladding, and fire rated windows. Project value: £8.5m",
        image: "/images/projects/skyline-chambers.jpeg",
      },
      {
        name: "O Central",
        ...
        type: "Residential Development",
        status: "Current",
        description: "12-month facade remediation with new render, aluminium cladding, and firestopping. Project value: £6.4m",
        image: "/images/projects/o-central.jpeg",
      },
      // Completed Projects
      {
        ...
        type: "Residential Development",
        status: "Completed",
        description: "Full facade remediation completed in 11 months. Project value: £5.1m",
        image: "/images/projects/celestial-house.jpeg",
      },
      {
        ...
        type: "Residential Development",
        status: "Completed",
        description: "Facade remediation completed in 10 months including new render and insulation. Project value: £5.0m",
        image: "/images/projects/the-interchange.jpeg",
      },
      {
        name: "Falcondale Court",
        location: "Park Royal, London",
        type: "Residential Development",
        status: "Completed",
        description: "11-month remediation project with new spandrel panels and zinc cladding. Project value: £4.5m",
        image: "/images/projects/falcondale-court.jpeg",
      },
      {
        name: "Landmark",
        ...
        type: "Residential Development",
        status: "Completed",
        description: "Full facade remediation completed in 11 months. Project value: £4.9m",
        image: "/images/projects/landmark.jpeg",
      },
      {
        name: "Century Tower",
        location: "Chelmsford",
        type: "Residential Development",
        status: "Completed",
        description: "Facade remediation completed June 2022 with new aluminium cladding and balustrades. Project value: £3.1m",
        image: "/images/projects/century-tower.jpeg",
      },
      {
        name: "Burton Place",
        location: "Manchester",
        type: "Residential Development",
        status: "Completed",
        description: "12-month major remediation with new SFS stud system and aluminium cladding. Project value: £14.7m",
        image: "/images/projects/burton-place.jpeg",
      },
    ],
  },
