      ...
      <div className="container-editorial">
        ...
        >
          ...
          <a href="/" className="inline-flex items-baseline gap-1 group whitespace-nowrap">
            <span className="text-xl md:text-2xl lg:text-3xl font-semibold text-white tracking-wide">
              {company.prefix}
            </span>
            <span className="text-white/30 mx-1 md:mx-2">|</span>
            <span className="text-[10px] min-[480px]:text-xs md:text-base lg:text-lg tracking-[0.12em] md:tracking-[0.15em] uppercase text-white/50 group-hover:text-white/70 transition-colors duration-300">
              {company.name}
            </span>
          </a>
