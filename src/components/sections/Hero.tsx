...
export function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden" data-hero>
      ...
      {/* UK City Skyline background - positioned in front initially */}
      <div className="absolute inset-0 flex items-end justify-center pb-[15vh] sm:pb-[12vh] md:pb-[10vh] z-[5]">
        <motion.svg
          viewBox="0 0 400 280"
      ...
      {/* Content - Logo emerges from behind skyline */}
      <div className="container-wide relative z-10 text-center px-4 sm:px-6 pt-[12vh] md:pt-[15vh] lg:pt-[18vh] pb-[25vh] sm:pb-[22vh] md:pb-[18vh]" style={{ transform: 'translateZ(0)' }}>
        <motion.div
